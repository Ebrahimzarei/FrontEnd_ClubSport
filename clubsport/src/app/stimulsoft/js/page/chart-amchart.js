...
function barChartWithImg() {
  ...
  chart.data = [{
    ...
    "bullet": "assets/img/users/user-1.png"
  }, {
    "name": "دیمن",
    "points": 65456,
    "color": chart.colors.next(),
    "bullet": "assets/img/users/user-2.png"
  }, {
    "name": "پاتریک",
    "points": 45724,
    "color": chart.colors.next(),
    "bullet": "assets/img/users/user-3.png"
  }, {
    "name": "سارا",
    "points": 13654,
    "color": chart.colors.next(),
    "bullet": "assets/img/users/user-4.png"
  },
    {
      "name": "پوژا",
      "points": 32589,
      "color": chart.colors.next(),
      "bullet": "assets/img/users/user-5.png"
    },
    {
      "name": "جین",
      "points": 45895,
      "color": chart.colors.next(),
      "bullet": "assets/img/users/user-6.png"
    },
  ];
...
function dumbbellPlotChart() {
  ...
  series.tooltipText = "باز: {openValueY.value} بسته: {valueY.value}";
  series.sequencedInterpolation = true;
...
function mapBubble() {
  ...
  title.text = "[bold font-size: 20]جمعیت کشورها در سال 2011[/]\nمنبع";
  ...
  var mapData = [
    ...
    { "id": "DZ", "name": "آلمان", "value": 35980193, "color": chart.colors.getIndex(2) }
  ];

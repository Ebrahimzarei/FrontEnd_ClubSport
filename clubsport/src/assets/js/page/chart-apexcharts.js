...
function chart1() {
    var options = {
        ...
        xaxis: {
            categories: ['مرداد', 'تیر', 'فروردین', 'اسفند', 'بهمن', 'دی ', 'آذر', 'آبان', 'مهر'],
            labels: {
                style: {
                    colors: '#9aa0ac',
                }
...
function chart2() {
    ...
    var options = {
        ...
        xaxis: {
            categories: ["شهریور", "مرداد", "تیر", "خرداد", "اردیبهشت", "فروردین", "بهمن", "دی", "اسفند", "آذر", "آبان", "مهر"],
            position: 'top',
            labels: {
                offsetY: -18,
                style: {
...
function chart3() {
    var options = {
        ...
        xaxis: {
            categories: ['فروردین', 'اسفند', 'بهمن', 'دی', 'آذر', 'آبان', 'مهر'],
            title: {
                text: 'ماه'
            },
            labels: {

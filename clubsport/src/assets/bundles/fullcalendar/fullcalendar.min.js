...
!function (t, e) {
    ...
    return function (t) {
        ...
        e.globalDefaults = {
            ...
            defaultView: "month",
            aspectRatio: 1.35,
            header: {left: "title", center: "", right: "امروز prev,next"},
            weekends: !0,
            weekNumbers: !1,
            weekNumberTitle: "W",
        ...
        i.defineView("لیست", {
            class: r.default,
            buttonTextKey: "لیست",
            defaults: {buttonText: "لیست", listDayFormat: "LL", noEventsMessage: "No events to display"}
        ...
        }), i.defineView("listYear", {type: "لیست", duration: {year: 1}, defaults: {listDayAltFormat: "dddd"}})
    }, function (t, e) {
        Object.defineProperty(e, "__esModule", {value: !0})
    }])
});